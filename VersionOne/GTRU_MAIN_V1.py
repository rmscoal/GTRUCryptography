...
Aplikasi GTRU Menggunakan Z^n Versi 1
___________________________________________
...
'''
KUMPULAN FUNGSI UNTUK MENCARI INVERS POLINOMIAL 
'''
...
'''
FUNGSI PEMBANGUNAN MATRIKS DAN OPERASI MOD DI MATRIKS
'''
...
'''
PEMBANGUNGAN KUNCI DAN OPERASI ENKRIPSI & DESKRIPSI
'''
...
'''
PENYESUAIAN MESSAGE MENJADI BINARY BIT
'''
...
def main(params, message):
    ...
    print("--- waktu dekripsi : %s milidetik ---" % ((time.time() - start_time_dekripsi)*1000))

    print("\n--- waktu total (temasuk pembangunan kunci) : %s seconds ---" % (time.time() - start_time))

if __name__ == '__main__':
    params = list((251,2,2521)) #nilai-nilai untuk n, p, dan q secara berurutan. 
